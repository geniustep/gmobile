...
class Api {
  ...
  static Future<void> request(
    ...
    if (response.data["success"] == 0) {
      ...
      // التحقق أولاً مما إذا كانت الاستجابة تحتوي على "error"
      if (response.data.containsKey("error") &&
        ...
        // إذا لم تكن "error" أو "result"، تعامل مع الحالة الافتراضية
        onError('Unexpected response structure', response.data);
      }
    }
