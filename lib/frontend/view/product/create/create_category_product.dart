...
// import 'package:g_solution/widgets/constant.dart';
...
//   Future<RxList<ProductCategoryModel>> getData() async {
//     prdtCategory.clear();
//     prdtCategoryWithoutParent.clear();
...
//                       hintText:
//                           '${Localize.name.tr.toUpperCase()} ${Localize.categories.tr.toUpperCase()}',
//                       labelText:
//                           '${Localize.name.tr.toUpperCase()} ${Localize.categories.tr.toUpperCase()}',
//                     ),
//                     onChanged: (val) {
...
//                           Icons.person_pin,
//                         ),
//                         labelText: Localize.parent.tr.toUpperCase()),
//                     name: "parent_id",
